...
fig1=go.Figure()
fig1.add_trace(go.Scatter(x=dtat_date.index,y=dtat_date['newdeaths'],fill = 'tonexty',line_color='red'))
fig1.update_layout(title = 'NEW DEATH Cases Worldwide')
fig1.write_html('FIGs.html',auto_open=True)

fig2=go.Figure()
fig2.add_trace(go.Scatter(x=dtat_date.index,y=dtat_date['newcases'],fill='tonexty',line_color='green'))
fig2.update_layout(title ="NEW CASES worldwide" )
fig2.write_html('FIG2q.html',auto_open=True)